...
class PHPMailer
{
    ...
    public function setLanguage($langcode = 'en', $lang_path = '')
    {
        ...
        $PHPMAILER_LANG = [
            'authenticate' => 'خطای SMTP : امکان دسترسی وجود ندارد.',
            'connect_host' => 'خطای SMTP : امکان دسترسی به هاست SMTP نمی باشد.',
            'data_not_accepted' => 'خطای SMTP: داده مورد تایید نیست.',
            'empty_message' => 'فیلد متن خالی است',
            'encoding' => 'رمزگذاری ناشناخته:  ',
            'execute' => 'اجرا نمی شود:  ',
            'file_access' => 'امکان دسترسی به پرونده وجود ندارد:  ',
            'file_open' => 'خطای فایل : فایل باز نمی شود :  ',
            'from_failed' => 'دنبال کردن آدرس فایل با شکست مواجه شد:  ',
            'instantiate' => 'عدم تایید عملکرد پست الکترونیکی',
            'invalid_address' => 'آدرس نامعتبر : ',
            'mailer_not_supported' => ' سرویس ارسال ایمیل پشتیبانی نمیشود.',
            'provide_address' => 'شما باید حداقل یک آذرس گیرنده ایمیل مشخص کنید.',
            'recipients_failed' => 'خطای SMTP : عدم دریافت دنبال کنندگان :  ',
            'signing' => 'خطای امضا:  ',
            'smtp_connect_failed' => ' ارتباط SMTP شکست خورد',
            'smtp_error' => 'خطای سرور SMTP: ',
            'variable_set' => 'نمی توان تغیر را تنظیم یا تنظیم مجدد کرد:  ',
            'extension_missing' => 'پسوند اشتباه:  '
        ];
        if (empty($lang_path)) {
